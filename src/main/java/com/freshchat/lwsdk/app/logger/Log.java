package com.freshchat.lwsdk.app.logger;
...
import com.freshchat.lwsdk.app.reports.AllureReport;
import com.freshchat.lwsdk.app.reports.ExtentReport;
...
public class Log {
	...
	public static void fail(String message) {
		...
		AllureReport.printFailedTextLog(message);
	...
	public static void fail(ITestResult result) {
		...
		AllureReport.printFailedLogWithScreenShot(logText, result);
